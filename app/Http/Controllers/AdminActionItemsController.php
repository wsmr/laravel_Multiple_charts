<?php namespace App\Http\Controllers;
	...
	class AdminActionItemsController extends \crocodicstudio\crudbooster\controllers\CBController {
...
//			$this->col[] = ["label"=>"Last Update On","name"=>"last_update"];
          ...
          //   $this->table_row_color[] = ["condition"=>"[DATEDIFF(CURDATE(),revised_date)] > '7'","color"=>"danger"];
	         // $this->table_row_color[] = ["condition"=>"[DaysDue] >'0' and [DaysDue] <= '7' ","color"=>"warning"];
	         //  $this->table_row_color[] = ["condition"=>"[DaysDue] <='0' ","color"=>"info"];
...
switch($column_value) {
   case 'Completed':
     $column_value = "<span class='label label-success'>Completed</span>";
   break;
   case 'InProgress':
    $column_value = "<span class='label label-info'>In-progress</span>";
   break;
   case 'Open':
    $column_value = "<span class='label label-warning'>Open</span>";
   break;
   default:
