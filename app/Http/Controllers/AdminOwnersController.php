<?php namespace App\Http\Controllers;
	...
	class AdminOwnersController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		public function cbInit() {
			...
			$this->col[] = ["label"=>"Short Code","name"=>"short_code"];
	    ...
	    */
	    public function hook_before_delete($id) {
	        //Your code here
			$count = DB::table('action_items')->where('owners_id',$id)->count();
			$count1 = DB::table('countries')->where('owners_id',$id)->count();
                        if($count > 0 || $count1 > 0 ){
                                CRUDBooster::redirect(CRUDBooster::mainpath(""),"You cannot a delete this record","danger");
                        }
                        else{
                                $res = DB::table('owners')->where('id',$id)->delete();
                                CRUDBooster::redirect(CRUDBooster::mainpath(""),"Owner Deleted","success");
                        }
	    }
